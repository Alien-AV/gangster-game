...
You start with a single lieutenant who can extort for cash. As you perform actions new options will unlock. Use the buttons to recruit mooks, assign them to patrols, hire more lieutenants and buy businesses. Each lieutenant has their own action buttons and progress bars showing how long tasks take.
